...
class User(models.Model):
    ...
    mid = models.ForeignKey(Mentor, models.DO_NOTHING, db_column='mId', blank=True, null=True)  # Field name made lowercase.
...
class Auditlog(models.Model):
    stu = models.ForeignKey(User, models.DO_NOTHING, blank=True, null=True)
    mentor = models.ForeignKey(Mentor, models.DO_NOTHING, blank=True, null=True)
